  ...
  services: {
    ...
    plans: [
...

      {
        ...
        description:
          "A clean, professional static website with a scoped delivery",
        included: [
...

      {
        ...
        description:
          "A website with selected pre-configured features and admin editing",
        included: [
...

      {
        ...
        description:
          "Tailored web applications and custom features built to your requirements",
        included: [
...

      {
        ...
        description:
          "Ongoing delivery with a monthly cadence and prioritized response",
        included: [
...

      {
        ...
        description:
          "Design, installation, and support of complete IT environments",
        included: [
    ...
    cta: "Request a quote",
    customNote:
      "Pricing is based on scope and complexity. A detailed quote is provided after an initial discovery session.",
  },
    ...
    projects: [
      {
        ...
        description:
          "Custom web platform to manage members, events, subscriptions, and administrative workflows. Centralizes operations and improves visibility across the organization.",
      ...
      },
      {
        ...
        description:
          "End-to-end delivery of an online store including product catalog, content administration, and purchasing flows where relevant.",
      ...
      },
      {
        ...
        description:
          "Business web application to manage clients, facilities, operational workflows, and editable website content. Designed to be fully usable by non-technical staff without touching code.",
      ...
      },
      {
        ...
        description:
          "Internal application to track operational services and activities, replacing manual processes and spreadsheets with structured data and visibility.",
      ...
      },
      {
        ...
        description:
          "Design and deployment of a complete IT infrastructure, including workstations, servers, peripherals, secure connectivity, and ongoing support.",
      ...
      },
      {
        ...
        description:
          "Consulting mission focused on analyzing field operations, reviewing existing tools, and defining a digital solution to reduce time loss and improve efficiency.",
    ...
    steps: [
      {
        ...
        name: "Discovery",
        description:
          "Understanding your needs, constraints, and operational context",
        icon: "Search",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        name: "Build",
        description:
          "Implementation with structured delivery and quality control",
        icon: "Code",
      },
      {
        id: 4,
